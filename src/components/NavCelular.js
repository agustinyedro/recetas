    ...
    this.shadowRoot.innerHTML = /* HTML */ `
      ...
      <div id="burger-nav">
        ...
        <nav id="nav-bar-burger" class="hidden">
          ...
          <a class="a" href="pages/recetas.html">Recetas</a>
          <a class="a" href="pages/aboutme.html">Sobre mi</a>
          <a class="a" href="pages/contacto.html">Contacto</a>
          <div id="nav-bar-burger-redes-sociales">
            <a href=""
              ><img src="../public/img/svg/instagram.svg" alt="logo-instagram"
            /></a>
            <a href=""
              ><img src="../public/img/svg/logo-github.svg" alt="logo-github"
            /></a>
          </div>
        </nav>
      </div>
